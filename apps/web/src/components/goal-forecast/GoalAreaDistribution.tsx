...
import { AREA_PALETTE } from "./goalForecastColors";
import type { GoalAreaBucket } from "@/types";

export function GoalAreaDistribution({ areas }: { areas: GoalAreaBucket[] }) {
        ...
        <div className="flex items-center gap-5 flex-wrap">
          <div className="relative w-32 h-32 shrink-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              ...
              <span className="text-[10px] text-slate">metas</span>
            </div>
          </div>
