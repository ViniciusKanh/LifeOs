import { Target, BarChart3, CalendarCheck2, Gauge } from "lucide-react";
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
      ...
      <Card className="p-4">
        ...
        <p className="text-xs text-slate mt-1">Conclusões previstas em 3 meses</p>
      </Card>
      <Card className="p-4">
        ...
        <p className="text-xs text-slate mt-1">Ritmo de evolução {summary.paceMultiplier == null && "— dados insuficientes"}</p>
      </Card>
    </div>
  );
}
